				...
				<div class="card card-earnings">
					<div class="p-2 card">
						<form class="user" id="validate" method="post" novalidate="novalidate"
							action="<?php echo base_url($fire['slug'].'/fire-extinguisher');?>" enctype="multipart/form-data">
							<div class="form-group">
								<input type="hidden" name="id" value="<?php echo $fire['id'];?>" />
							...
							<div class="form-group">
								...
								<input type="date"
									...
									value="<?php echo $fire['expiration'];?>" />
...
<script>
	...
	function DeleteImage() {
		$('#certificate').attr('src', '<?php echo base_url('
			assets / uploads / certificates / noimage.png ');?>');
		$('#pdferror').text('')
	}
</script>
