				...
				<div class="card card-earnings">
					<div class="p-2 card">
						<form class="user" id="validate" method="post" novalidate="novalidate"
							action="<?php echo base_url($student['slug'].'/certificate');?>">
							<div class="form-group">
								<input type="hidden" name="id" value="<?php echo $student['id'];?>" />
								<label htmlFor="student">Student</label>
								<input type="text"
									class="form-control form-control-user <?php if(form_error('student')): echo "is-invalid"; endif;?>"
									id="student" name="text" required placeholder="Enter student name"
									value="<?php echo $student['student'];?>" />
							...
							<div class="form-group">
								...
								<input type="text"
									...
									id="student_no" name="text" required placeholder="Enter student number"
									value="<?php echo $student['student_no'];?>" />
							...
							<div class="form-group">
								...
								<input type="date"
									...
									value="<?php echo $student['expiration'];?>" />
								...
								<div class="form-group col-md-4">
									<div class="grid-margin stretch-card">
										<div class="d-flex flex-row">
											<embed
												src="<?php echo base_url('assets/uploads/certificates/'.$student['certificate']);?>"
...
<script>
	...
	function DeleteImage() {
		$('#certificate').attr('src', '<?php echo base_url('
			assets/uploads/certificates/'.$student['
			certificate ']);?>');
		$('#pdferror').text('')
	}
